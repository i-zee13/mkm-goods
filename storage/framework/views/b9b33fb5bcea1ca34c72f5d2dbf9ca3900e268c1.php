...
<div class="row mt-2 mb-3">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('batches')); ?>"><span>Batches </span></a></li>
            <li><span>Add</span></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a href="<?php echo e(route('add-batch')); ?>" class="btn add_button add_faqs"><i class="fa fa-plus"></i> <span>Add
                        Batch</span></a>
...
endpush -->
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/course/batch.blade.php ENDPATH**/ ?>