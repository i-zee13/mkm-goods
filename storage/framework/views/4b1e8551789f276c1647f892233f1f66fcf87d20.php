                ...
                <div class="col-12 bulksection p-0">
                    <div id="floating-label">
                        <div class="form-wrap p-0">
                            ...
                            <a href="/download-sample-client" class="sample_download_link"> <button type="button" class="btn btn-primary font13" style="margin-bottom:15px; margin-top: 10px">Sample
                                    Download</button>
                            </a>
                    ...
                    <div style="display:none" class="alert alert-danger error_message_div" role="alert"> <strong>Failed!
                        </strong> Following Students are not added due to wrong formatting </div>
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01 mb-15">Student <span>Management</span></h2>
    </div>
            ...
            <div class="row">
                <div class="col-auto">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active top-tabs" id="nav-home-tab" type="customer" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Student List<span class="_cus-val count_customers"> 0 </span></a>
                ...
                <div class="col">
                    <div class="Product-Filter Cus-Filter">
                        <div class="row">
                            ...
                            <a class="btn btn-addproduct  mb-0" href="/import-students"><i class="fa fa-upload"></i> Bulk
                                    Upload </a>
                                <a href="/student-create" class="btn text-white btn-addproduct mb-0 "><i class="fa fa-plus"></i> Add Student </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/student/list.blade.php ENDPATH**/ ?>