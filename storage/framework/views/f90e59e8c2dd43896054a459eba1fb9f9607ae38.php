...
<div class="row mt-2 mb-3">
  <div class="col-lg-6 col-md-6 col-sm-6">
    <h2 class="_head01">Builty Puhnch  <span>Management</span></h2>
  </div>
  <div class="col-lg-6 col-md-6 col-sm-6">
    <ol class="breadcrumb">
      <li><a href="/students"><span>Builty Puhnch</span></a></li>
...
<form id="form" enctype="multipart/form-data" class="">
  ...
  <input type="text" id="hidden_builty_puhnch_id" value="<?php echo e($builty_puhnch->id); ?>" name="id" hidden>
...
<div class="body pocPROFILE">
          <div class="row"> <div class="col-12">
              <div class="header pt-0">
                <h2>Manage <span>Builty Puhnch :</span></h2>
              </div>
            </div>
            ...
            <table class="table table-bordered mg-b-0"  >
              <thead>
                <tr>
                  ...
                  <th width="90px">Builty Puhnch</th>
              ...
              <tbody>
                <tr> 
                  <td>1</td>
                  <td><?php echo e($builty_puhnch->goods); ?></td>
                  <td><?php echo e($order->commission); ?></td>
                  <td><?php echo e($builty_puhnch->total_rent); ?></td>
                  <td><?php echo e($builty_puhnch->puhnch_baqaya); ?></td>
                ...
                <tr>
                  <th colspan="2" style="text-align: right">Total Builty Puhnch</th>
                  <td><b><?php echo e($builty_puhnch->puhnch_baqaya); ?></b> Rs. </td>
                  <th colspan="2" style="text-align: right">Total Rupees</th>
                  <td><b><?php echo e($builty_puhnch->total_rent); ?></b> Rs. </td>
                </tr>
                <tr>
                  <td colspan="2" style="text-align: right"> Received Builty Puhnch</td>
                  <td>
                    <input type="hidden" name="received_builty_puhnch" id="received_amount" value="0" style="width: 10em">
                    <b><?php echo e($builty_puhnch->received_puhunch_baqya); ?></b> Rs.
                  </td>
                  <td colspan="3"></td>
                </tr>
                <tr>
                  <td colspan="2" style="text-align: right">Remaining Builty Puhnch</td>
                  <td>
                    <b><?php echo e($builty_puhnch->balance); ?></b> Rs.
                  </td>
                  <td colspan="3"></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: right">Add New Builty Puhnch</td>
                  <td>
                    <input type="number" id="new_builty_puhnch" class="in-table" max="<?php echo e($builty_puhnch->balance); ?>" min="0" name="new_builty_puhnch" value="<?php echo e($builty_puhnch->balance); ?>" style="width:100px " required="">
                  </td>
                  
                </tr><tr>
                  <td colspan="12"><input id="btn-save-builty_puhnch" data-id="<?php echo e($builty_puhnch->id); ?>" type="submit" name="submit" value="Submit" class="btn btn-primary btn-sm" style="float:right"></td>
                </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Sourcecode-Academia-BE\resources\views/builty-puhnch/edit.blade.php ENDPATH**/ ?>