...
<?php echo e($errors->first('fb_link')); ?>
...
<div id="blureEffct" class="container-fluid">
  ...
  <div class="container">
    <form id="form" enctype="multipart/form-data" class="">
      <?php echo csrf_field(); ?>
      <input type="hidden" id="hidden_country" value="<?php echo e($data !=null ? $data->country_id : ''); ?>" name="hidden_country_id">
      <input type="hidden" id="hidden_state" value="<?php echo e($data !=null ? $data->state_id : ''); ?>" name="hidden_state_id">
      <input type="hidden" id="hidden_city" value="<?php echo e($data !=null ? $data->city_id : ''); ?>" name="hidden_city_id">
      <input type="hidden" value="<?php echo e($data !=null ? $data->id : ''); ?>" name="hidden_id">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="" class="form-control required" placeholder="" value="<?php echo e($data!=null ?  $data->name : ''); ?>" name="name">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="control-label mb-10">Phone *</label>
                        <input type="text" id="phone_number" class="form-control required" placeholder="" value="<?php echo e($data!=null ?  $data->phone_number : ''); ?>" name="phone_number">
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="control-label mb-10">Email *</label>
                        <input type="text" id="email" class="form-control required" placeholder="" value="<?php echo e($data!=null ?  $data->email : ''); ?>" name="email">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        ...
                        <input type="text" id="" class="form-control  url_fb    " placeholder="" value="<?php echo e($data!=null ?  $data->fb_link : ''); ?>" name="fb_link">
                    ...
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        ...
                        <input type="text" id="" class="form-control   url_insta" placeholder="" value="<?php echo e($data!=null ?  $data->insta_link : ''); ?>" name="insta_link">
                      </div>
                    </div>
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        <label class="control-label mb-10">Youtube Link</label>
                        <input type="text" id="" class="form-control   url_youtube" placeholder="" value="<?php echo e($data!=null ?  $data->youtube_link : ''); ?>" name="youtube_link">
                      </div>
                    </div>
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        <label class="control-label mb-10">Twitter Link</label>
                        <input type="text" id="" class="form-control   url_twitter" placeholder="" value="<?php echo e($data!=null ?  $data->twitter_link : ''); ?>" name="twitter_link">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        ...
                        <input type="text" id="" class="form-control   url_linked_in" placeholder="" value="<?php echo e($data!=null ?  $data->linkedin_link : ''); ?>" name="linked_in_link">
                      </div>
                    </div>
                    ...
                    <div class="col-md-12 pt-10">
                      <div class="form-group">
                        <label class="control-label mb-10">Address *</label>
                        <input type="text" id="" class="form-control required" placeholder="" value="<?php echo e($data!=null ?  $data->address : ''); ?>" name="address">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 pt-7">
                      <div class="form-group">
                        <label class="control-label mb-10">Postal Code </label>
                        <input type="text" id="" class="form-control required" placeholder="" placeholder="" maxlength="6" minlength="6" name="postal_code_id" value="<?php echo e($data!=null ?  $data->postal_code : ''); ?>">
                      </div>
                    </div>
                    <?php if($data !=null && $data->id != null): ?>
          ...
          <div class="card mb-30">
            ...
            <div class="col-md-12 PT-10 PB-10">
              <div class="form-wrap p-0">
                ...
                <input type="hidden" name="hidden_logo_img" value="<?php echo e($data !='' ? $data->logo_img : ''); ?>">
                <input type="file" id="input-file-now" data-default-file="/storage/<?php echo e($data !='' ? $data->logo_img : ''); ?>" class="dropify" name="logo_img" data-old_input="hidden_logo_img" accept="image/*" data-allowed-file-extensions="jpg png jpeg JPEG" />
              </div>
            </div>
          </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/organization/index.blade.php ENDPATH**/ ?>