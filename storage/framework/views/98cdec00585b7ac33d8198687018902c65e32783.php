...
<div id="product-cl-sec">
    ...
    <div class="pro-header-text">New <span>Sub Category</span></div>
                                    ...
                                    <div id="floating-label" class="card p-20 top_border mb-3" style="width: 100%">
                                        ...
                                        <div class="form-wrap p-0">
                                            <div class="row">
                                                ...
                                                <label class="font12 mb-0">Main Category*</label>   
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="sub-img">
                                                        <input type="file" id="input-file-now" data-default-file="" class="dropify" name="service_icon"  accept="image/*" data-allowed-file-extensions="jpg png jpeg JPEG" />
                                                    </div>
                                                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a class="btn add_button openDataSidebarForAddingSubCat"><i class="fa fa-plus"></i> New Sub Category</a>
                <h2>Sub Category Areas</h2>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/categories/sub.blade.php ENDPATH**/ ?>