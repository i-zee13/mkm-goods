...
<div class="row mt-2 mb-3">
  ...
  <div class="col-lg-6 col-md-6 col-sm-6">
    <ol class="breadcrumb">
      <li><a href="/students"><span>Order</span></a></li>
      <li><span>Add</span></li>
    </ol>
  </div>
</div>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-wrap p-0">
                ...
                <input type="text" id="" class="form-control first_name student_required " placeholder="" name="invoice_no" id="invoice_no">

              </div>
              <div class="col-md-3 mb-10">

                      <label class="control-label mb-5">Date  *</label>
                      <input type="text" id="" class="form-control student_required  datepicker" placeholder="" name="date">

               </div>
                    <div class="col-md-3 mb-10 ">

                      <label class="control-label mb-5">Vehical No *</label>
                      <input type="text" id="" class="form-control first_name student_required " placeholder="" name="vehical_no" id="vehical_no">

                    </div>
                    <div class="col-md-3 mb-10">

                      <label class="control-label mb-5">From *</label>
                      <input type="text" id="" class="form-control  student_required " placeholder="" name="order_from">
                    ...
                    <div class="col-md-3 mb-10">
                      ...
                      <input type="text" id="" class="form-control student_required " placeholder="" name="order_to">

                    </div>
                      <div class="col-md-3 mb-10">

                      <label class="control-label mb-5">Adda Name  *</label>
                      <input type="text" id="" class="form-control student_required " placeholder="" name="add_name">
                    ...
                    <div class="col-md-3">
                      ...
                      <div>
                        <input  type="text" class="form-control student_required" name="goods">
                     ...
                     <div class="col-md-3">
                      ...
                      <label class="control-label mb-5">Rent *</label>
                      <div>
                        <input  type="number" class="form-control student_required" name="total_rent">
                     ...
                     <div class="col-md-3">
                      ...
                      <label class="control-label mb-5">Builty Puhunch*</label>
                      <div>
                        <input  type="number" class="form-control student_required" name="builty_punch">
                    ...
                    <div class="col-md-3">
                      ...
                      <label class="control-label mb-5">Commission *</label>
                      <div>
                        <input  type="number" class="form-control student_required" name="commission">
                     ...
                     <div class="col-md-3">
                      ...
                      <label class="control-label mb-5">To Pay *</label>
                      <div>
                        <input  type="text" class="form-control student_required" name="to_pay">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Sourcecode-Academia-BE\resources\views/orders/create.blade.php ENDPATH**/ ?>