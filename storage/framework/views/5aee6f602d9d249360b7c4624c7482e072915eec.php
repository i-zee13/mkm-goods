...
<body id="page-top">
    ...
    <div id="wrapper">
        <?php if(explode('/',Request::path())[0] != 'CompletedOrderDetail'): ?>
        <?php echo $__env->make('includes.nav-new', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <div id="content-wrapper">
            <div class="overlay-blure"></div>
            <div class="overlay-for-sidebar" style="display: none"></div>
            <?php echo $__env->make('includes.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="container <?php echo e(Request::path() == 'dashboard' ? 'container-1240 _dashboard' : ''); ?>">
                ...
                <?php echo $__env->yieldContent('data-sidebar'); ?>
    ...
    <script src="<?php echo e(url('ckfinder/ckfinder.js')); ?>"></script>
    ...
    <?php if($controller == "Correspondence"): ?>
    ...
    <?php elseif($controller == "DashboardController"): ?>
    <script src="/js/chart.bundle.min.js"></script>
    <script src="/js/chartjs.js"></script>
    <script src="/js/echarts-en.min.js"></script>
    <script src="/js/echarts-liquidfill.min.js"></script>
    ...
    <script>
        var rightsGiven = JSON.parse('<?php echo json_encode($userPermissions); ?>');
        var userDesignation = JSON.parse('<?php echo $designation->pnl_access; ?>');
        var allControllersData = JSON.parse('<?php echo json_encode($allControllers); ?>');
        var controller = '<?php echo $controller; ?>';
        var controllerAction = '<?php echo $action; ?>';
        var currentSegment = '<?php echo Request::segment(1); ?>';
        var csrfToken = $('[name="csrf_token"]').attr('content');
        var loggedInUser =
            '<?php echo json_encode(["user_id" => Auth::user()->id, "name" => Auth::user()->name, "picture" => Auth::user()->picture]); ?>';
    ...
    <script src="/js/master.js?v=<?php echo e(time()); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/layouts/master.blade.php ENDPATH**/ ?>