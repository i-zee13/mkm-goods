  ...
  <div id="content-wrapper">
    ...
    <div class="container">
      ...
      <form id="form" enctype="multipart/form-data">
        ...
        <input type="text" id="hidden_student_id" value="<?php echo e($client->id); ?>" name="id" hidden>
                ...
                <div class="se_cus-type p-20 mb-3">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-10 ">
                      ...
                      <input type="text" id="" class="form-control   student_required" placeholder="" value="<?php echo e($client->student_code); ?>" name="student_code" id="student_code">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-s2">
                        <select class="form-control formselect student_required" placeholder="Select Account Type" name="account_type" id="account_type">
                          ...
                          <option value="1" <?php echo e($client->account_type == 1 ? 'Selected' : ''); ?>>Primary</option>
                          <option value="2" <?php echo e($client->account_type == 2 ? 'Selected' : ''); ?>>Secondary</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 relation_type" >
                      ...
                      <div class="form-s2">
                        <select class="form-control formselect form_field_required" placeholder="Select Relationship" value="<?php echo e($client->relationship_type); ?>" name="relationship_type">
                          <option value="0">Select Relationship </option>
                          <option value="1" <?php echo e($client->relationship_type == 1 ? 'Selected' : ''); ?>>Father</option>
                          <option value="2" <?php echo e($client->relationship_type == 2 ? 'Selected' : ''); ?>>Mother</option>
                          <option value="3" <?php echo e($client->relationship_type == 3 ? 'Selected' : ''); ?>>Son</option>
                          <option value="4" <?php echo e($client->relationship_type == 4 ? 'Selected' : ''); ?>>Daughter</option>
                          <option value="5" <?php echo e($client->relationship_type == 5 ? 'Selected' : ''); ?>>Brother</option>
                          <option value="6" <?php echo e($client->relationship_type == 6 ? 'Selected' : ''); ?>>Sister</option>
                          <option value="7" <?php echo e($client->relationship_type == 7 ? 'Selected' : ''); ?>>Spouse</option>
                          <option value="8" <?php echo e($client->relationship_type == 8 ? 'Selected' : ''); ?>>Legal Partner</option>
                          <option value="9" <?php echo e($client->relationship_type == 9 ? 'Selected' : ''); ?>>Relative</option>
                          <option value="10" <?php echo e($client->relationship_type == 10 ? 'Selected' : ''); ?>>Friend</option>
                          <option value="11" <?php echo e($client->relationship_type == 11 ? 'Selected' : ''); ?>>Business Partner</option>
                        </select>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="password" name="password" class="form-control student_required" placeholder="" value="<?php echo e($client->password); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/client/edit.blade.php ENDPATH**/ ?>