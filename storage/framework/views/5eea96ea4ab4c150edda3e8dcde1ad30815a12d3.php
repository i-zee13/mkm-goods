...
<div class="row">
    <div class="col-md-12 mb-30">
        ...
        <input type="hidden" class="hidden_campaign_id"  name="hidden_campaign_id" value="<?php echo e($campaign->id); ?>">
                        ...
                        <div class="col pr-0">
                            ...
                            <div class="form-s2">
                                <select class="form-control formselect required" placeholder="select Scheme Type" style="width: 100%" name="campaign_type">
                                    <option value="1" <?php echo e($campaign->campaign_type == 1 ? 'selected' : ''); ?> >Discount on Price</option>
                        ...
                        <div class="col pr-0">
                            ...
                            <div class="form-s2">
                                <select class="form-control formselect discount_type required"  placeholder="select Scheme Type" name="discount_type" style="width: 100%">
                                    <option value="1" <?php echo e($campaign->discount_type == 1 ? 'selected' : ''); ?>>Value</option>
                                    <option value="2" <?php echo e($campaign->discount_type == 2 ? 'selected' : ''); ?>>Percentage</option>
                                </select>
                            </div>
                        </div>
                        <div class="col pr-0">
                            <div class="form-group">
                                ...
                                <input type="text" id="discount" class="form-control required only_numerics " name="campaign_discount" placeholder="" value="<?php echo e($campaign->campaign_discount); ?>">
                            </div>
                        </div>
                        <div class="col pr-0">
                            <div class="form-group">
                                <label class="control-label mb-5">Campaign Title *</label>
                                <input type="text" id="" class="form-control required" name="campaign_title"  placeholder="" value="<?php echo e($campaign->campaign_title); ?>">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label class="control-label mb-5">Label Title *</label>
                                <input type="text" id="Title" class="form-control required" name="label_title" placeholder="" value="<?php echo e($campaign->label_title); ?>">
                            </div>
                        </div>
                    ...
                    <div class="row form-wrap p-0">
                        ...
                        <div class="col-3">
                            <div class="form-group" style="height: auto">
                                ...
                                <input type="text" class="form-control datepicker required" placeholder="" name="start_date" value="<?php echo e($campaign->start_date); ?>">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group" style="height: auto">
                                <label class="control-label mb-5">End Date</label>
                                <input type="text" class="form-control datepicker required" placeholder="" name="end_date" value="<?php echo e($campaign->end_date); ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row retailerTable">
                ...
                <div class="col-12">
                    ...
                    <!-- <table class="table table-hover dt-responsive nowrap" id="example" style="width:100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $campaign_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><button type="button" id="add-btn" class="btn btn-default btn-line mb-0 add-btn" course-id="<?php echo e($course->id); ?>"  batch-id="<?php echo e($course->batch_id); ?>" status="<?php echo e($course->status); ?>">Add</button></td>
                            </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/campaigns/edit.blade.php ENDPATH**/ ?>