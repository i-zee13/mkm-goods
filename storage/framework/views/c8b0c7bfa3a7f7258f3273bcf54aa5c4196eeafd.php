						...
						<div class="row">
							<div class="col-12">
								<form style="display: flex;" id="saveClientForm">
									<?php echo csrf_field(); ?>
									<input type="text" id="client_id" name="client_id" value="<?php echo e($client->id); ?>" hidden>
									<input type="text" id="gender_id" name="gender_id" value="<?php echo e($client->gender_id); ?>" hidden>
										...
										<div class="form-wrap p-0">
												...
												<div class="col-md-6">
													<div class="form-s2">
														...
														<select class="form-control formselect" placeholder="select Document Type" name="document_type">
															...
															<option value="<?php echo e($document->id); ?>"><?php echo e($document->document_verification_name); ?></option>
											...
											<div class="row relatives_form_div">
												...
												<div class="col-md-6 pt-5">
													...
													<input type="text" class="form-control" value="<?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?>" readonly hidden>
		...
		<div id="blureEffct" class="container">
			...
			<div class="row mt-2 mb-3">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<h2 class="_head01">Client : <span> <?php echo e($client->first_name); ?></span></h2>
				</div>
							...
							<div class="row">
								<div class="col-12">
									<div class="header pt-0">
										...
										<button type="button" class="btn add_button" style="top:-6px!important; right:0!important;" id="edit_client_record" data-id="<?php echo e($client->id); ?>" onClick="edit_client('<?php echo e($client->id); ?>')"><i class="fa fa-pencil"></i> <span> Edit</span></button>
									</div>
								</div>
								<input type="text" id="client_main_details_id" name="client_main_details_id" value="<?php echo e($client->id); ?>" hidden>
										...
										<div class="row">
											<div class="col-md-4 p-col-L">
												<div class="infoDiv">
													...
													<p><strong>
															<?php echo e($client->client_type ? $client->client_type  : "NA"); ?>
											...
											<div class="col-md-4 p-col-R p-col-L">
												<div class="infoDiv">
													...
													<p><strong>
															...
															<?php echo e($client->acquisition_source ? $client->acquisition_source : "NA"); ?>
											...
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													...
													<p><strong>
															<?php echo e(($client->life_cycle_stage==1 ? ' Lead' : ($client->life_cycle_stage==2 ? 'Prospect' :($client->life_cycle_stage==3 ? 'Client' : 'Churned' )))); ?>
										...
										<div class="row">
											<div class="col-md-4 p-col-L">
												<div class="infoDiv">
													...
													<p><strong><?php echo e($client->first_name); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R p-col-L">
												<div class="infoDiv">
													<label class="control-label">Middle Name</label>
													<p><strong><?php echo e($client->middle_name ? $client->middle_name : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													<label class="control-label">Last Name</label>
													<p><strong><?php echo e($client->last_name); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-L">
												<div class="infoDiv">
													<label class="control-label">Date of Birth</label>
													<p><strong><?php echo e($client->dob ? $client->dob : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R p-col-L">
												<div class="infoDiv">
													<label class="control-label">Gender</label>
													<p><strong><?php echo e($client->gender ? $client->gender : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													<label class="control-label">Residency Status</label>
													<p><strong><?php echo e($client->residence ? $client->residence : "NA"); ?></strong></p>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-4 p-col-L">
												<div class="infoDiv">
													...
													<p><strong><?php echo e($client->primary_landline ? $client->primary_landline : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R p-col-L">
												<div class="infoDiv">
													<label class="control-label">Cell Phone Number</label>
													<p><strong><?php echo e($client->primary_cellphone ? $client->primary_cellphone : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													<label class="control-label">email</label>
													<p><strong><?php echo e($client->email ? $client->email : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-8 p-col-L">
												<div class="infoDiv">
													<label class="control-label">Home Address</label>
													<p><strong><?php echo e($client->primary_address ? $client->primary_address : "NA"); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													<label class="control-label">Country</label>
													<p><strong> <?php echo e($client->country); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-L">
												<div class="infoDiv">
													<label class="control-label">State/Province</label>
													<p><strong><?php echo e($client->state); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-L p-col-R">
												<div class="infoDiv">
													<label class="control-label">City</label>
													<p><strong> <?php echo e($client->city); ?></strong></p>
												</div>
											</div>
											<div class="col-md-4 p-col-R">
												<div class="infoDiv">
													<label class="control-label">Postal Code</label>
													<p><strong><?php echo e($client->postal_code ? $client->postal_code : "NA"); ?></strong></p>
												</div>
											</div>
										</div>
									</div>
			...
			<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/client/index.blade.php ENDPATH**/ ?>