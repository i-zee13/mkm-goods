...
<div class="row mt-2 mb-3">
  <div class="col-lg-6 col-md-6 col-sm-6">
    <h2 class="_head01">Teacher Registration <span>& Verification Form</span></h2>
  </div>
  <div class="col-lg-6 col-md-6 col-sm-6">
    <ol class="breadcrumb">
        ...
        <div class="body pocPROFILE">
          ...
          <div class="se_cus-type p-20 mb-3">
            <div class="row">
              ...
              <div class="col-md-4">
              <label class="control-label mb-5">Acquisition Source *</label>
                <div class="form-s2">
              ...
              <div class="col-md-4 mb-10 ">
                ...
                <input type="text" id="" class="form-control  student_required " placeholder="" name="instructor_code" id="instructor_code">

              </div>
              <div class="col-md-4">

                <label class="control-label mb-5">Date of Joining (YYYY, MM ,DD ) *</label>
                <div>
                  <input id="datepicker" type="text" class="form-control student_required" name="date_of_joining">
                ...
                <div class="infoDiv p-15">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-10 ">
                      ...
                      <select class="custom-select  custom-select-sm student_required"   name="gender_id">
                      <option value="0">Select Gender </option>
                        <?php $__currentLoopData = $genders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($gender->id); ?>"><?php echo e($gender->gender_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    ...
                    <div class="col-md-4">
                      ...
                      <div>
                        <input id="datepicker2" type="text" class="form-control student_required" name="dob">
                ...
                <div class="infoDiv p-15">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-10">
                      ...
                      <input type="text" id="secondary_phone" class="form-control student_required" placeholder="" name="secondary_phone">
                    </div>
                    <div class="col-md-4 mb-10">
                      <label class="control-label mb-5">Whatsapp Number *</label>
                      <input type="text" id="whatsapp_no" class="form-control student_required" placeholder="" name="whatsapp_no">
                    </div>
                    <div class="col-md-4 mb-10">
                      <div class="form-s2">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/teacher/create.blade.php ENDPATH**/ ?>