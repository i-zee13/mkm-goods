            ...
            <div class="plist-content">
                <div class="_left-filter">
                    <form id="saveLessonForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" class="course_id" name="course_id" value="<?php echo e($course_id); ?>">
...
endpush -->
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/course/lesson.blade.php ENDPATH**/ ?>