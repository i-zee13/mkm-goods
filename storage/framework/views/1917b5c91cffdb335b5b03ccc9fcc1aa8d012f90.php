                                        ...
                                        <div class="form-s2">
                                            <select class="form-control services-info" name="primary_service_id" id="primary_service_id" placeholder="select Main Category">
                                                ...
                                                <?php $__currentLoopData = $primary_services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $primary_service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($primary_service->id); ?>"><?php echo e($primary_service->service_name); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Lms\Sourcecode-Academia-BE\resources\views/faqs/faqs.blade.php ENDPATH**/ ?>