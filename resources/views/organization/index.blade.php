          ...
          <div class="card mb-30">
            ...
            <div class="col-md-12 PT-10 PB-10">
              <div class="form-wrap p-0">
                ...
                <input type="file" id="input-file-now" data-default-file="/storage/{{$data !='' ? $data->logo_img : ''}}" class="dropify" name="logo_img" data-old_input="hidden_logo_img" accept="image/*" data-allowed-file-extensions="jpg png jpeg JPEG" />
              </div>
            </div>
          </div>
