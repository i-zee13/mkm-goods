...
<div class="row mt-2 mb-3">
    <div class="col-md-12">
        <h2 class="_head01 float-left">New <span>Performa</span></h2>
    </div>
    <div class="col-md-3">
    </div>
</div>
<div class="row mt-2">
    ...
    <div class="Action_bottom">
        <div class="button-section align-right">
            <a href="/Performas" class="btn btn-primary mr-2 btn-cancel">Cancel</a>

            <button id="saveAsPerforma" class="btn btn-primary mr-2">Save</button>
