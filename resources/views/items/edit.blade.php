                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-3 pr-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="item_recipe_name" name="item_recipe_name" value="{{$r_name}}" class="form-control" placeholder="">
                                </div>
                            </div>
                            ...
                            <table class="table table-hover nowrap editItemsTable" style="width:100%;">
                                ...
                                @foreach($recipeData as $data)
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control text-filed" name="ingValue" value="{{$data->ingredients_value}}" id="ingValue_{{$data->ing_id}}" onchange="plusIngValues({{$data->ing_id}});"></td>
                                        <td><button type="button" name="{{$data->ingredients_name}}" id="{{$data->ing_id}}" class="btn btn-default red-bg removeIngBtnGrid" title="Delete">Remove</button></td>
                                    </tr>
                                @endforeach
