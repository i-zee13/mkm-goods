                    ...
                    <div class="row form-wrap p-0">
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group" style="height: auto">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="" name="start_date" value="{{Carbon\Carbon::now()->format('Y-m-d')}}">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group" style="height: auto">
                    ...
                    <table class="table table-hover dt-responsive nowrap" id="example" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" id="add-btn" class="btn btn-default btn-line mb-0 add-btn" course-id="{{$course->id}}"  batch-id="{{$course->batch_id}}" status="1">Add</button></td>
                            </tr>
                            @endforeach
                </tbody>
                </table>
