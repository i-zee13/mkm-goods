                                                ...
                                                <div class="_sa-customer" style="padding: 0; max-width: 100%">
                                                    <div class="form-s2 selpluse">
                                                        <select class="form-control formselect"
                                                            ...
                                                            @if(!in_array($customer->competition, $looped) &&
                                                            $customer->competition)
                                                            <option value="{{ $customer->competition }}">
                                                                {{ $customer->competition }}</option>
                                                            <?php $looped[] = $customer->competition; ?>
                                                            @endif
                                                            @endforeach
                                                        </select>
            ...
            <div class="card cp-mh">
                <div class="body">
                    ...
                    <div class="con_info">
                        ...
                        <a id="{{ $update_customer->id }}"
                            class="btn-primary float-right openDataSidebarForUpdateCustomer"
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="tab1" data-toggle="tab" href="#tab01" role="tab"
                            aria-controls="tab01" aria-selected="true">Order List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tab2" data-toggle="tab" href="#tab02" role="tab" aria-controls="tab02"
                            aria-selected="false">Left-Over Stock</a>
                    </li>
                </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-default" data-toggle="modal"
                                            data-target=".modal-order-detail" title="Order Detail"><i
                    ...
                    <div class="tab-pane fade show" id="tab02" role="tabpanel" aria-labelledby="tab2">
                        <table class="table table-hover dt-responsive nowrap" id="example" style="width: 100%;">
                            ...
                            <tbody>
                                @foreach ($stock as $s)
                                <tr>
                                    <td> {!! $s->product . " <small>".$s->item."</small>" !!} </td>
                                    {{-- <td> {{ $s->expiry }} </td> --}}
                                    <td> {{ $s->stock }} </td>
                                    <td> Wave Off </td>
                                </tr>
