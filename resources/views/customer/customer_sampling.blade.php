...
@section('content')
{{-- Modal --}}
<div class="modal fade customer_sampling" id="customer_sampling" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="col-md-3 pr-0">
                    <div class="form-s2">
                        <select class="form-control formselect select_product_sample sampling_dropdown_product" id=""
                ...
                <div class="col-md-3 pr-0">
                    <div class="form-s2">
                        <select class="form-control formselect select_item_sample sampling_dropdown_item" id=""
                            placeholder="Select Supplier">
                            ...
                            <div class="col-4">
                                <div class="assigned-to">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Tracking Id*</label>
...
{{-- Display Sampling --}}
<div class="modal fade display_sampling" id="display_sampling" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title _head03"> Quote List</h5>
                </div>
            <div class="modal-body pt-5">
                <div id="floating-label" class="form-wrap pt-0 pb-0">
                    <div class="row">
                        <div class="col-md-12 productRate-table m-0">
                            <table class="table table-hover dt-responsive nowrap table-PL sample_table" style="width:100% !important ">
                                <thead>
                                    <tr>
                                        <th>Product</th>
                                        <th>Item</th>
...
<div class="row mt-2 mb-3">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01">Customer <span>Sampling</span></h2>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="#"><span>Customer Sampling</span></a></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a class="btn add_button" data-toggle="modal" data-target=".customer_sampling"><i class="fa fa-plus"></i> Add Sample</a>
                <h2>Samples List</h2>
            </div>
