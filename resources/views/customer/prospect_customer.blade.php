                                    ...
                                    <div id="floating-label" class="card p-20 top_border mb-3">
                                        ...
                                        <div class="form-wrap p-0">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10">Business Phone*</label>
                                                        <input type="text" name="pocBusPh" class="form-control required"
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="_sa-customer" style="padding: 0; max-width: 100%">
                                                <div class="form-s2 selpluse">
                                                    <select class="form-control formselect"
                                                        ...
                                                        <option value="0" disabled selected>Select Competition</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-s2 pt-19">
                                                    ...
                                                    <select class="form-control formselect" name="interested_in_product"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-s2 pt-19">
                                                    ...
                                                    <select class="form-control formselect"
                                                        name="interested_in_category"
                                                        placeholder="Interested in Service">
                                        ...
                                        <div class="form-s2 pt-19">
                                            ...
                                            <select class="form-control formselect required"
                                                placeholder="Contact Status" name="status" id="competitionSelect2">
                                                <option value="prospect">Prospect</option>
                                                <option value="lead">Sales Qualified Lead</option>
                                            </select>
                                        </div>
                                        <div class="form-wrap p-0">
                                            <div class="row">
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 1170px;">
        <div class="modal-content top_border">
            ...
            <div class="modal-body">
                <div class="col-12 bulksection">
                    <div id="floating-label">
                        <div class="form-wrap p-0">
                            <a href="/download_sample_customers"> <button type="button"
                                    class="btn btn-primary mr-1 mb-15">Sample
                                    Download</button></a>
                    ...
                    <div style="display:none" class="alert alert-success uploaded_data_div" role="alert">
                        <strong>Success!
                        </strong> Following Customers have been uploaded successfully!
                    </div>
                    <div class="table-responsive uploaded_customers_table">
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a style="margin-right:150px;" data-toggle="modal" data-target=".bd-example-modal-lg"
                    class="btn add_button uploadblukcust"><i class="fa fa-plus"></i> Upload Bulk</a>
