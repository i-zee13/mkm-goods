  ...
  <div id="content-wrapper">
    ...
    <div class="container">
      ...
      <form id="form" enctype="multipart/form-data">
        ...
        <input type="text" id="hidden_teacher_id" value="{{$client->id}}" name="id" hidden>
                ...
                <div class="se_cus-type p-20 mb-3">
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-10 ">
                      ...
                      <input type="text" id="" class="form-control   student_required" placeholder="" value="{{$client->instructor_code}}" name="instructor_code" id="instructor_code">
                    ...
                    <div class="col-md-4">
                      ...
                      <div>
                        <input id="datepicker" type="text" class="form-control student_required" value="{{$client->date_of_joining}}" name="date_of_joining">
