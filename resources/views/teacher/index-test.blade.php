...
<style>
  ...
  .pocPROFILE .form-s2 .select2-container .select2-selection--single, .phoneinput {
    box-shadow: none;
    height: 33px;
  ...
  .closeBTN-d {
                          ...
                          outline: none; display: block; opacity: 0.5; margin-top: 5px;
                        }
                        .closeBTN-d:HOVER,
                        .closeBTN-d:focus {  opacity:1;  background: #f12300; border: solid 1px #f12300 !important;}
                        .closeBTN-d i{color: #fff !important; }
                ...
                <div class="se_cus-type p-20 mb-3">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-s2 ">
                        <select class="form-control formselect" placeholder="Acquisition Source">
                          <option>Life Cycle Stage*</option>
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-wrap p-0">
                      ...
                      <div class="infoDiv p-15">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div class="header pt-0">
                              <h3>Address <span> </span> <a class="addBTN-act"><i class="fa fa-plus"></i> Add Address</a></h3>
                      ...
                      <div class="row">
                        <div class="col pr-0">
                          <div class="form-group phone-SL row"> 
                            ...
                            <div class="col p-0">
                              <input class="phoneinput" type="text" placeholder="">
                            </div>
                          </div>
                        </div>
                     
                        <div class="col-auto">
                          <button type="submit" class="closeBTN-d"><i
                      ...
                      <div class="infoDiv p-15">
                        ...
                        <div class="col-md-4 mb-10">
                          ...
                          <div class="col-md-4 mb-10">
                            ...
                            <input type="text" id="" class="form-control" placeholder="" name="PostalCode_id">
                          </div>
