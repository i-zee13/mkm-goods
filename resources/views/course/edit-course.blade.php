                    ...
                    <div class="card">
                        ...
                        <div class="body p-0">
                            <form id="course_form">
                                ...
                                <input type="hidden" class="hidden_course_id"      name="hidden_course_id" value="{{$course->id}}">
                                <input type="hidden" class="hidden_course_status"  name="hidden_course_status" value="{{$course->status}}" >
                                        ...
                                        <div class="col-3">
                                            ...
                                            <div class="form-s2">
                                                <select class="form-control formselect main_category course-required" placeholder="select Main Category" style="width:100%!important" name="main_category_id" value="">
                                                    <option value="{{$course->main_category_id}}">{{$course->main_category}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-3 pl-0">
                                            ...
                                            <div class="form-s2">
                                                <select class="form-control formselect sub_category course-required" placeholder="select Sub Category" style="width:100%!important" name="sub_category_id">
                                                    <option value="{{$course->sub_category_id}}">{{$course->sub_category}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-3 pl-0">
                                            ...
                                            <div class="form-s2">
                                                <select class="form-control formselect course-required" placeholder="select Designation" style="width:100%!important" name="course_methodology">
                                                    ...
                                                    <option value="1" {{$course->course_methodology ==1 ? 'selected' : ''}}> Classroom</option>
                                                    <option value="2" {{$course->course_methodology ==2 ? 'selected' : ''}}>Skill Development</option>
                                                    <option value="3" {{$course->course_methodology ==3 ? 'selected' : ''}}>One on One Coaching Session</option>
                                                    <option value="4" {{$course->course_methodology ==4 ? 'selected' : ''}}>Corporate Program</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-3 pl-0">
                                            ...
                                            <div class="form-s2">
                                                <select class="form-control formselect course-required" placeholder="select Designation" style="width:100%!important" name="course_type">
                                                    ...
                                                    <option value="1" {{$course->course_type ==1 ? 'selected' : ''}}>Live sessions</option>
                                                    <option value="2" {{$course->course_type ==2 ? 'selected' : ''}}>On Demand</option>
                                                    <option value="3" {{$course->course_type ==3 ? 'selected' : ''}}>Webinar</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row Addpro-form">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control course-required" name="course_code" value="{{$course->course_code}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-s2">
                                                            <select class="form-control formselect course-required" placeholder="select Course Level" style="width:100%!important" name="course_level">
                                                                ...
                                                                <option value="1" {{$course->course_level ==1 ? 'selected' : ''}}>Beginner</option>
                                                                <option value="2" {{$course->course_level ==2 ? 'selected' : ''}}>Intermidate</option>
                                                                <option value="3" {{$course->course_level ==3 ? 'selected' : ''}}>Advanced</option>
                                                                <option value="4" {{$course->course_level ==4 ? 'selected' : ''}}>Expert</option>
                                                                <option value="5" {{$course->course_level ==5 ? 'selected' : ''}}>NA</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto PT-8">
                                                                <div class="custom-control custom-radio font14">
                                                                    <input class="custom-control-input" type="radio" name="course_pricing_model" id="yes001" value="1" {{$course->course_pricing_model == 1 ? 'checked="true"' : '' }}>
                                                                    <label class="custom-control-label" for="yes001">Standard</label>
                                                                </div>
                                                            </div>
                                                            <div class="col pl-0 PT-8">
                                                                <div class="custom-control custom-radio font14">
                                                                    <input class="custom-control-input" type="radio" name="course_pricing_model" id="no001" value="2" {{$course->course_pricing_model == 2 ? 'checked="true"' : '' }}>
                                            ...
                                            <div class="col-6 course_price" {{$course->course_pricing_model == 1 ? 'style=display:block' : 'style=display:none' }}>
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-4 col-form-label">Course Price *</label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" name="course_price" value="{{$course->course_price}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control course-required" name="course_title" value="{{$course->course_title}}">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="form-s2">
                                                            <select class="form-control formselect course-required" placeholder="select Course Subscription" style="width:100%!important" name="course_subscription_method">
                                                                ...
                                                                <option value="1" {{$course->course_subscription_method ==1 ? 'selected' : ''}}>Monthly</option>
                                                                <option value="2" {{$course->course_subscription_method ==2 ? 'selected' : ''}}>One time</option>
                                                                <option value="3" {{$course->course_subscription_method ==3 ? 'selected' : ''}}>Quarterly</option>
                                                                <option value="4" {{$course->course_subscription_method ==4 ? 'selected' : ''}}>Annual</option>
                                                                <option value="5" {{$course->course_subscription_method ==5 ? 'selected' : ''}}>Free</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control course-required" name="course_duration" value="{{$course->course_duration}}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7 pl-0 font14">
                                                        <div class="row">
                                                            <div class="col-auto  pl-0 PT-5">
                                                                <div class="custom-control custom-radio">
                                                                    <input class="custom-control-input" type="radio" name="course_incubator" id="yes005" value="1" {{$course->course_incubator == 1 ? 'checked="true"' : '' }}>
                                                                    <label class="custom-control-label" for="yes005">Yes</label>
                                                                </div>
                                                            </div>
                                                            <div class="col pl-0 PT-5">
                                                                <div class="custom-control custom-radio">
                                                                    <input class="custom-control-input" type="radio" name="course_incubator" id="no005" value="2" {{$course->course_incubator == 2 ? 'checked="true"' : '' }}>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    <label for="" class="col-sm-2 col-form-label">Short
                                                        Description *</label>
                                                    <div class="col-sm-10">
                                                        <textarea class="proTextarea course-required"   name="short_description">{{$course->short_description}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="proTextarea course-required" name="long_description">{{$course->long_description}}</textarea>
                                            ...
                                            <div class="col-12 Weightage-sec">
                                                ...
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-6 h-border pr-0">
                                                        <div class="switch-div">
                                                            <span class="btn_text">{{$course->gradutation_switch_btn == 1 ? 'Hide' : 'Show'}}</span>
                                                            <label class="switch">
                                                                <input type="checkbox" class="show_btn" name="gradutation_switch_btn" value="{{$course->gradutation_switch_btn}}" {{$course->gradutation_switch_btn == 1 ? 'checked' :''}}>
                                                ...
                                                <div class="show_gradution_block" {{$course->gradutation_switch_btn == 1 ? 'style=display:block' : 'style=display:none'}}>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control" name="minimum_quiz_score" value="{{$course->minimum_quiz_score}}">
                                                        </div>
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control only_numerics" name="quiz_weightage" value="{{$course->quiz_weightage}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control" name="minimum_attendnace" value="{{$course->minimum_attendnace}}">
                                                        </div>
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control only_numerics" name="attendance_weightage" value="{{$course->attendance_weightage}}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4 PT-7">
                                                        ...
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control" name="minimum_assignment_score" value="{{$course->minimum_assignment_score}}">
                                                        </div>
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control only_numerics" name="assignment_weightage" value="{{$course->assignment_weightage}}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-4 PT-7">
                                                        ...
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control" name="minimum_participation_score" value="{{$course->minimum_participation_score}}">
                                                        </div>
                                                        <div class="col-3 pl-0">
                                                            <input type="text" class="form-control only_numerics" name="participation_weightage" value="{{$course->participation_weightage}}">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="row">
                                                    <div class="col-4 PT-7">
                                                    ...
                                                    <div class="row total-Weightage">
                                                        ...
                                                        <div class="col-3 pl-0">
                                                            ...
                                                            <input type="text" name="total_weightage" class="form-control total_weightage" placeholder="{{$course->quiz_weightage + $course->attendance_weightage + $course->participation_weightage + $course->assignment_weightage}}%" data-value="{{$course->quiz_weightage + $course->attendance_weightage + $course->participation_weightage + $course->assignment_weightage}}" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 PT-20">
                                                        ...
                                                        <table width="100%" class="table nowrap table-type">
                                                            <tbody class="multiple_attribute_tbl">
                                                                @foreach($course_attribute as $attribute)
                                                                <tr id="#new-row-">

                                                                    <td style="width:395px">{{$attribute->attibure_name}}</td>
                                                                    <td>{{$attribute->attribute_value}}</td>
                                                                    <td><button class="btn btn-primary red-bg  remove" id="{{$attribute->id}}" data-id="{{$attribute->attibure_name}}"><i class="fa fa-trash"></i></button>
                                                                    </td>
                                                                </tr>
                                                                @endforeach
                                                ...
                                                <div class="add-property">
                                                    ...
                                                    <div class="row m-0">
                                                        <div class="col-12 multiple_tags_tbl">
                                                            ...
                                                            <div class="alert fade show alert-color _add-secon" role="alert" >{{$tag->tag_name}}
                                                                <button type="button" class="close" data-value="{{$tag->tag_name}}" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                                                            </div>
                                         ...
                                         @foreach($seo_description as $data)
                                            <div class="row Addpro-form">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 col-form-label">Page Meta
                                                            Title</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="page_meta"  value="{{$data['page_meta']}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 col-form-label">Meta
                                                            Description</label>
                                                        <div class="col-sm-9">
                                                            <textarea class="proTextarea"  name="meta_description">{{$data['meta_description']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <textarea class="proTextarea" name="meta_keywords">{{$data['meta_keywords']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 pr-0 col-form-label">Meta
                                                            Property URL</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="meta_property_url" value="{{$data['meta_property_url']}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 pr-0 col-form-label">Meta
                                                            Property Type</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="meta_property_type"  value="{{$data['meta_property_type']}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 col-form-label">Meta Property
                                                            Title</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control" name="meta_property_title"  value="{{$data['meta_property_title']}}"> 
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 col-form-label">Meta Property
                                                            Description</label>
                                                        <div class="col-sm-9">
                                                            <textarea class="proTextarea" name="meta_property_description"> {{$data['meta_property_description']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-wrap p-0">
                                                                ...
                                                                <input type="file" id="input-file-now" data-default-file="/storage/{{$course !='' ? $course->meta_property_image : ''}}" class="dropify" name="meta_property_image" 
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        <label for="" class="col-sm-3 col-form-label">Footer
                                                            Content</label>
                                                        <div class="col-sm-9">
                                                            <textarea class="proTextarea" name="footer_content">{{$data['footer_content']}} </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="Product-imgUpload">
                                            ...
                                            <div class="col-md-12 PT-5 PB-15">
                                                <div class="form-wrap p-0">
                                                    ...
                                                    <div class="upload-pic"></div>
                                                    <input type="hidden" name="hidden_course_thumbnail" value="{{$course !='' ? $course->course_thumbnail : ''}}">
                                                    <input type="file" id="input-file-now" data-default-file="/storage/{{$course !='' ? $course->course_thumbnail : ''}}" class="dropify" name="course_thumbnail" 
                                            ...
                                            <div class="col-md-12 PT-5">
                                                <div class="form-wrap p-0">
                                                    ...
                                                    <div class="upload-pic"></div>
                                                    <input type="hidden" name="hidden_course_desktop_cover_image" value="{{$course !='' ? $course->course_desktop_cover_image : ''}}">
                                                    <input type="file" id="input-file-now" data-default-file="/storage/{{$course !='' ? $course->course_desktop_cover_image : ''}}" class="dropify" name="course_desktop_cover_image" 
                                            ...
                                            <div class="col-md-12 PT-5">
                                                <div class="form-wrap p-0">
                                                    ...
                                                    <div class="upload-pic"></div>
                                                    <input type="hidden" name="hidden_course_tablet_cover_image" value="{{$course !='' ? $course->course_tablet_cover_image : ''}}">
                                                    <input type="file" id="input-file-now" data-default-file="/storage/{{$course !='' ? $course->course_tablet_cover_image : ''}}" class="dropify " name="course_tablet_cover_image" 
                                            ...
                                            <div class="col-md-12 PT-5">
                                                <div class="form-wrap p-0">
                                                    ...
                                                    <div class="upload-pic"></div>
                                                    <input type="hidden" name="hidden_course_mobile_cover_image" value="{{$course !='' ? $course->course_mobile_cover_image : ''}}">
                                                    <input type="file" id="input-file-now" data-default-file="/storage/{{$course !='' ? $course->course_mobile_cover_image : ''}}" class="dropify " name="course_mobile_cover_image" 
                                            ...
                                            <div class="col-12 Addpro-form PT-10">
                                                ...
                                                <div class="control-group">
                                                    <input type="text" class="form-control" name="youtube_link" value="{{$course->youtube_link}}">
