            ...
            <div class="card">
                ...
                <div class="body p-0">
                    <form id="saveBatchForm">
                        @csrf
                        <input type="hidden" name="hidden_batch_id" value="{{$batch->id}}" class="hidden_batch_id">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-s2 pt-19">
                                            <select id="course_list" class="form-control formselect batch-required " placeholder="select Course " name="course_id"  >
                                                ...
                                                <option value="{{$course->id}}" {{$batch->course_id == $course->id ? 'selected' : ''}}>{{$course->course_code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control batch-required" placeholder="" name="batch_code" value="{{$batch->batch_code}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Batch Title *</label>
                                            <input type="text" id="" class="form-control batch-required" placeholder="" name="batch_title" value="{{$batch->batch_title}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control batch_price only_numerics" placeholder="" name="batch_price" value="{{$batch->batch_price}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Batch Duration (In Months) </batch-wise></label>
                                            <input type="text" id="" class="form-control   only_numerics batch-required" placeholder="" name="batch_duration" value="{{$batch->batch_duration_in_months}}">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Batch Description *</label>
                                            <textarea id="" class="form-control " placeholder="" name="batch_description"> {{$batch->batch_description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" style="height: auto">
                                            <input type="text" id="datepicker3" class="form-control batch-required" placeholder="" name="enrollment_start_date" value="{{$batch->enr_start_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" style="height: auto">
                                            <input type="text" id="datepicker4" class="form-control batch-required" placeholder="" name="enrollment_end_date" value="{{$batch->enr_end_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" style="height: auto">
                                            <input type="text" id="datepicker" class="form-control batch-required" placeholder="" name="batch_start_date" value="{{$batch->batch_start_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" style="height: auto">
                                            <input type="text" id="datepicker2" class="form-control batch-required" placeholder="" name="batch_end_date" value="{{$batch->batch_end_date}}">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="" class="form-control only_numerics" placeholder="" name="grace_period" value="{{$batch->grace_period}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Early Bird Discount (in Percantage)</label>
                                            <input type="text" id="" class="form-control only_numerics" placeholder="" name="eb_discount" value="{{$batch->eb_discount}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Early Bird Max Days</label>
                                            <input type="text" id="" class="form-control only_numerics" placeholder="" name="eb_max_days" value="{{$batch->eb_max_days}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="sesssion_duration" class="form-control   only_numerics batch-required" placeholder="" name="session_duration" value="{{$batch->session_duration_in_minutes}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10">Total Sessions *</label>
                                            <input type="text" id="" class="form-control batch-required" placeholder="" name="total_sessions" value="{{$batch->total_sessions}}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto pr-0">
                                                <div class="custom-control custom-radio font14">
                                                    <input class="custom-control-input active" type="radio" name="batch_status" id="q-mc-01" value="1" {{$batch->status == 1 ?'checked="checked"' : ''}} >
                                                    <label class="custom-control-label" for="q-mc-01">Active</label>
                                                </div>
                                            </div>
                                            <div class="col pr-0">
                                                <div class="custom-control custom-radio font14">
                                                    <input class="custom-control-input inactive" type="radio" name="batch_status" id="q-tf-01" value="0" {{$batch->status == 0 ?'checked="checked"' : ''}}>
                                            ...
                                            <div class="col-12 PT-20">
                                                ...
                                                <table width="100%" class="table nowrap table-type">
                                                    <tbody class="multiple_slots_tbl">
                                                        @foreach($batch_slots as $key=>$slot)
                                                        <tr id="#new-row-">
                                                            <td style="width:100px">{{$key+1}}</td>
                                                            <td style="width:250">{{date('g:i A', strtotime($slot->start_time))}}</td>
                                                            <td>{{date('g:i A', strtotime($slot->end_time))}}</td>
                                                            <td><button class="btn btn-primary red-bg  remove" id="{{date('g:i A',strtotime($slot->start_time))}}"><i class="fa fa-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
