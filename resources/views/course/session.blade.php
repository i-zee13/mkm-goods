                                ...
                                <div class="col-12">
                                    <div id="floating-label" class="card p-20 top_border mb-3">
                                        ...
                                        <div class="form-wrap p-0">
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-s2 pt-19">
                                                        <select class="form-control formselect session-required slot" placeholder="select Instructor " name="primary_teacher_id">
                                                            <option value="0" selected>Select Batch Slot *</option>
                                                            @foreach($batch_slots as $slot)
                                                            <option value="{{$slot->id}}">{{date('g:i a',strtotime($slot->start_time))}} To {{date('g:i a',strtotime($slot->end_time))}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
