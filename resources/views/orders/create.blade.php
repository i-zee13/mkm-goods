        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8 right-sidebox">
                    ...
                    <div class="row">
                        <div class="col-6"><h2 class="title font22 PT-10 mb-10">New <span>Order</span></h2> </div>
                    ...
                    <div class="right_Info">
                        <div class="row inputfileds-top">
                            <div class="col-auto pr-0">Date <input type="Date" name="issueDate" class="inputfileds datefileds"> </div>
