        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-8 right-sidebox">
                    ...
                    <div class="row">
                        <div class="col-6"><h2 class="title font22 PT-10 mb-10">Edit <span>Order</span></h2> </div>
                    ...
                    <div class="right_Info">
                        ...
                        <div style="background-color: #f6f6f6; padding:10px; margin-top: 15px; margin-bottom: 0px; text-align: right; margin-bottom: 1px">
                            <button type="submit" class="btn btn-primary mr-2" onclick="updateOrder();">Update</button>
                            <button id="pl-close" type="submit" onclick="getToListingPage()" class="btn btn-cancel mr-2">Cancel</button>
                        </div>
