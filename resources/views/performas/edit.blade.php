        ...
        <div class="row">
            <div class="col-12">
                <div class="productSearch"><i class="fa fa-search"></i>
                    <input type="text" class="form-control performa_product_search" id="performa_product_search" placeholder="Search">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content  top_border">
            ...
            <div class="modal-body AddDetailPR">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 PT-8 mb-15">Add Quantity(CTN): </div>
                    <div class="col-md-8 mb-15">
                    ...
                    <div class="col-md-8">
                        <input type="text" id="itemUnitPrice" class="form-control" readonly style="font-size:13px">
                    </div>
                </div>
...
@section('content')
    <style>
        .OrderWrapper {padding: 0!important;}
        .itemQTY {
            font-size: 12px;
            width: 70px;
            padding: 0px 5px;
        ...
        .left-sidebox {
            -ms-flex: 420px;
            flex: 0 0 420px;
            max-width: 420px; padding-top: 15px; padding-bottom: 15px;
        }
        .sidebox-content {
        ...
        .title span {font-family: 'proximanova-light', sans-serif !important}
        .CompanyInfo{font-size: 14px; line-height: 26px;}
        .left-sidebox .form-s2 .select2-container .select2-selection--single, .left-sidebox .select2-container--default .select2-selection--multiple {
            height: 35px!important;
            border: 1px solid #dbdbdb;
            background-color: #ffffff;
        }
        .font22{font-size: 22px!important}
        .total-amt-top{ float: right}
        .custom-select-cs{width: 100px; border-radius: 0; width: 100px; border-radius: 0;  margin-top: 11px; background-color: #f6f6f6; height: 28px;}
        .TAM-div{font-family:'Rationale', sans-serif !important; font-size:28px; line-height: 1; text-align: right; }
        .TAM-div small{ display: block; font-size: 13px;font-family: 'proximanova-light', sans-serif !important; letter-spacing: 1px}
        .inputfileds-top{font-size: 14px; line-height: 30px; border-bottom: solid 1px #dbdbdb}
        .inputfileds, .inputfileds-top .custom-select-sm{font-size: 13px;line-height: normal; width: 110px; border-radius: 0; float: right; margin-left: 8px; border: solid 1px #dbdbdb ; height: 28px;padding-left: 5px; padding-right: 5px; margin-bottom: 15px;}
        .datefileds{width: 125px;}

        .inputfileds::-webkit-calendar-picker-indicator { margin: 2px}
        .inputvalue{width: 110px; border-radius: 0; border: solid 1px #dbdbdb; background-color:#f6f6f6; height: 24px; padding-left: 5px; padding-right: 5px; }
        ._notesTER{font-size: 14px; border: none}
        .textarea-HA, .textarea-NOTES, .textarea-TERMS, .textarea-PMessage {
            border: solid 1px #dbdbdb; margin-top: 5px
        }
        .ProductTable{width: 100%; margin-top: 15px; line-height: normal}
        .ProductTable th{font-family: proximanova-semibold, sans-serif!important; background-color: #f6f6f6;
            border-bottom:solid 1px #f6f6f6;  border-top:solid 1px #f6f6f6;  border-right:solid 1px #f6f6f6;
            font-size: 12px;
            text-align: left; padding: 3px;
        }
        .ProductTable th, .ProductTable td {font-size: 12px; padding:8px 5px; letter-spacing: normal}
        .ProductTable td{
            border-bottom:solid 1px #f6f6f6; border-right:solid 1px #f6f6f6;
            font-size: 12px; text-align: left;
        }
        .ProductTable td:first-child, .ProductTable th:first-child{border-left:solid 1px #f6f6f6;}
        .inputtable{border: solid 1px #dbdbdb; font-size: 12px; width: 70px; height: 24px;}
        ._order-delete {
            font-size: 15px;
            padding: 0px; margin:0px;
            color: #ffffff;
        }
        ._order-delete .fa {color: #868686; padding: 0; margin: 0}
        ._order-delete:HOVER .fa {color: #f12300}
        .totalValues{font-size: 14px;font-family: proximanova-semibold, sans-serif!important; }
        .totalValues td{padding: 7px 0px 7px 7px}
        .totalNo {font-family:'Rationale', sans-serif !important; font-size:24px; line-height: 1 }
        .td-pn{width:210px;}
        .se_cus-type .form-control, .se_cus-type .form-s2 .select2-container .select2-selection--single, .AddDetailPR .form-s2 .select2-container .select2-selection--single {
        ...
        @media (min-width: 1024px) {
            .left-sidebox {
                -ms-flex: 250px;
                flex: 0 0 250px;
                max-width: 250px; letter-spacing: normal
            }
            .right-sidebox{
                -ms-flex: 0 0 772px;
                flex: 0 0 772px;
        ...
        @media (min-width: 1280px) {
            .inputfileds-top{font-size: 13px}
            ...
            .left-sidebox {
                -ms-flex: 330px;
                flex: 0 0 330px;
                max-width: 330px; letter-spacing: normal
            }
            .right-sidebox{
                -ms-flex: 0 0 947px;
                flex: 0 0 947px;
            ...
            <div class="row">
                ...
                <div class="col-md-4 left-sidebox">
                    ...
                    <div class="sidebox-content">
                        <div class="CT_sec">
                            <h2 class="title pt-0 mb-0">Customer <span>Details</span></h2>
                            ...
                            <div class="row CompanyInfo">
                                <div class="col-md-5 pr-0"><strong>Company Name:</strong> </div>
                                <div class="col-md-7"><span id="company_name"></span></div>
                                <div class="col-md-5 pr-0"><strong>POC.:</strong></div>
                                <div class="col-md-7"><span id="poc_name"></span></div>
                                <div class="col-md-5 pr-0"><strong>City:</strong> </div>
                                <div class="col-md-7"><span id="city"></span></div>
                ...
                <div class="col-md-8 right-sidebox">
                    ...
                    <div class="row">
                        <div class="col-6"><h2 class="title font22 PT-10 mb-10">New <span>Proforma</span></h2> </div>
                    ...
                    <div class="right_Info">
                        <div class="row inputfileds-top">
                            <div class="col-auto pr-0">Date <input type="Date" name="issueDate" class="inputfileds datefileds" value="{{ $orderInfo['issue_date'] }}" readonly> </div>
                            <div class="col-auto pr-0">DOD <input type="Date" value="{{ $orderInfo['expected_delivery_date'] }}" name="expected_delivery_date" class="inputfileds datefileds"> </div>
                            <div class="col-auto pr-0">PO.NO. <input type="text" class="inputfileds" value="{{ $orderInfo['po_num'] }}" id="poNumForm"></div>
                            <div class="col-auto pr-0">Order Type
                            ...
                            {{--<div class="col-auto pr-0">Invoice # <input type="text" class="inputfileds"></div>--}}
                        </div>
                            ...
                            <div class="col-12">
                                <table class="totalValues" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:112px"><input type="text" name="discount" id="discount" value="{{ number_format($orderInfo['order_discount']) }}" class="inputvalue" style="font-size: 13px" placeholder="0.00" onkeypress="return isNumber(event)"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td align="right">Freight Charges</td>
                                        <td><input type="text" class="inputvalue" value="{{ number_format($orderInfo['actual_freight_charges']) }}" id="freight_charges" name="freight_charges" style="font-size: 13px" placeholder="0.00" onkeypress="return isNumber(event)"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td align="right">Insurance Charges</td>
                                        <td><input type="text" class="inputvalue" value="{{ number_format($orderInfo['insurance_charges']) }}" id="insurance_charges" name="insurance_charges" style="font-size: 13px" placeholder="0.00" onkeypress="return isNumber(event)"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td align="right">Genset Charges</td>
                                        <td><input type="text" class="inputvalue" value="{{ number_format($orderInfo['totalGenset']) }}" id="genset_charges" name="genset_charges" style="font-size: 13px" placeholder="0.00" onkeypress="return isNumber(event)"></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr style="border:solid 1px #dbdbdb">
                                        ...
                                        <td class="totalNo" align="right"><span id="total_ctn">0</span><small>Box</small></td>
                        ...
                        <div class="row _notesTER">
                            <div class="col-md-6">
                                Notes
                                <textarea class="textarea-NOTES" name="performa_notes" rows='2' placeholder="Enter Notes or bank transfer details" style="font-size: 13px">{{ $orderInfo["notes"] }}</textarea>
                            </div>

                            <div class="col-md-6">
                                Terms
                                <textarea class="textarea-TERMS" name="performa_terms" rows='2' placeholder="Enter your terms and conditions" style="font-size: 13px">{{ $orderInfo["terms"] }}</textarea>
                            </div>
                        </div>
                        {!! Form::hidden('performa_id', $orderInfo['performa_id']) !!}
                        ...
                        <div style="background-color: #f6f6f6; padding:10px; margin-top: 15px; margin-bottom: 0px; text-align: right; margin-bottom: 1px">
                            <button type="submit" class="btn btn-primary mr-2" onclick="updatePerforma();">Update</button>
                            <button id="pl-close" type="submit" onclick="goToListing()" class="btn btn-cancel mr-2">Cancel</button>
                        </div>
