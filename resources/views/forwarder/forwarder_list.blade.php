...
<div id="product-cl-sec">
    ...
    <div class="pro-header-text">New <span>Forwarder</span></div>
            ...
            <div class="plist-content">
                <div class="_left-filter pt-0">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <form style="display: flex;" id="saveForwarderForm">
                                    @csrf
                                    <input type="text" id="operation" name="operation" hidden>
                                    <input type="text" name="forwarder_id" hidden>
                                    <div id="floating-label" class="card p-20 top_border mb-3" style="width: 100%">
                                        <h2 class="_head03">Forwarder <span>Details</span></h2>
    ...
    <div class="_cl-bottom">
        <button type="submit" class="btn btn-primary mr-2" id="saveForwarder">Save</button>
        <button id="pl-close" type="submit" class="btn btn-cancel mr-2" id="cancelForwarder">Cancel</button>
    </div>
</div>
@endsection
@section('content')
...
{{-- Modal --}}
<div class="modal fade bd-example-modal-lg-bulk-Forwarder" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="col-12 bulksection p-0">
                    <div id="floating-label">
                        <div class="form-wrap p-0">
                            <a href="/download_sample_forwarder"> <button type="button" class="btn btn-primary font13" style=" margin-bottom:15px;">Sample
                                    Download</button></a>
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <form method="POST" enctype="multipart/form-data" id="upload_excel_form_forwarder">
                ...
                <div class="modal-footer  border-0">
                    ...
                    <button type="button" class="btn btn-primary upload_excel_file_forwarder">Bulk Upload</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="row mt-2 mb-3">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01">Forwarder <span>Management</span></h2>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="#"><span>Forwarder Companies</span></a></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a class="btn add_button openDataSidebarForAddingForwarder"><i class="fa fa-plus"></i> New Forwarder</a>
                <a style="margin-right:140px;" data-toggle="modal" data-target=".bd-example-modal-lg-bulk-Forwarder"
