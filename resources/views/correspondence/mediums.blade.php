...
<div id="product-cl-sec">
    ...
    <div class="pro-header-text">New <span>Medium</span></div>
    ...
    <div class="_cl-bottom">
        <button type="submit" class="btn btn-primary mr-2" id="saveMedium">Save</button>
...
<div class="row mt-2 mb-3">
    <div class="col-lg-6 col-md-6 col-sm-6">
        <h2 class="_head01">Mediums</h2>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6">
        <ol class="breadcrumb">
            <li><a href="#"><span>Mediums</span></a></li>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <a class="btn add_button openDataSidebarForAddingMediums"><i class="fa fa-plus"></i> New
                    Mediums</a>
                <h2>Mediums List</h2>
            </div>
