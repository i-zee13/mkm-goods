                ...
                <div class="card PB-20">
                    ...
                    <div class="col-12 p-0">
                        ...
                        <div class="header addPR-head mb-10">
                            <h2>Add <span> Production Stock</span> </h2>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3" id="select_batch_div">
                                <div class="form-s2 select_batch select_batch_of_stock">
                            ...
                            <div class="col-md-3" id="select_customer_div" style="display: none;">
                                <div class="form-s2 select_customer select_customer">
                                    <select id="select_customer" class="form-control formselect" placeholder="Select Customer">
                                ...
                                <form id="form_id">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $variant->name }}</td>
                                            <td><input id="manufacturing-date-{{$variant->id}}" type="text" class="form-control add-stock-input date-f manufacturing_date"></td>
                                            <td><input id="expiry-date-{{$variant->id}}" type="text" class="form-control add-stock-input date-f expiry_date" disabled></td>
                                            <td>
